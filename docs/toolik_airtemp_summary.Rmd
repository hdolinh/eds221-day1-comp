...
# use data.table::fread() for larger data sets
```
...
# cmd + shift + m will add a pipe operator ( %>% ) 
# %>% this reads as "and then"...the pipe operator allows us to write code that is more readable and in order (takes rid of all the parentheses)

# Now what are the column names?
# All the column names are now written in lowercase snake case 
```
